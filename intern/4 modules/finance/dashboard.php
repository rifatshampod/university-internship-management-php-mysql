				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Bursary | Dashboard</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Finance</span>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Approve payment</h2>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">View Payment</h2>
										
											<p class="cl-effect-1">
												<a href="view-payment.php">
													View all student Due
												</a>
											</p>
										</div>
									</div>
